...
public class TextFileInput  {
   ...
   public String[] returnArray() throws IOException {
      String line = br.readLine();
   ...
   public int[] returnIntArray() throws IOException {
      String temp = "";
      String line = br.readLine();
      int count = 0;
      while (line != null) {
      ...
      String[] numsStrings = temp.split(",");
      int nums[] = new int[count];
      for (int i = 0; i < count; i++) {
         nums[i] = Integer.valueOf(numsStrings[i]);
